use utf8;
package CookBloks::Schema::Result::Measure;
...
CookBloks::Schema::Result::Measure - types of measurements (cups, pounds, ounces, etc)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1Fz/0R8LC+IkzvNewZ2Vhg
